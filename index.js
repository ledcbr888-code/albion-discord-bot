...
async function handleImageTimer(message, imageUrl) {
    ...
    try {
        ...
        // 📥 ดาวน์โหลดรูปภาพเป็น Buffer ก่อนส่งให้ Tesseract เพื่อความเสถียร
        ...
        // ⏱️ รองรับการสแกนเวลาทั้งแบบมีตัวอักษร (h/m/s) และรูปแบบโคลอน (MM:SS / HH:MM:SS) ในเกม
        const timeRegexLetter = /(\d+)\s*(h|m|s)/gi;
        let match;
