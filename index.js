...
const express = require('express'); // [ขั้นตอนที่ 1] ดึงใช้งาน Express

// ======================================================
// [ขั้นตอนที่ 1] WEB SERVER FOR KEEP-ALIVE (RENDER)
// ======================================================
const app = express();
...
// ======================================================
// CONFIG & TRACKING LISTS (WITH PERSISTENT STORAGE)
// ======================================================

// [ขั้นตอนที่ 2] ใช้ Environment Variables และลบ Token ล่วงถอดถอนออกจากโค้ดเพื่อความปลอดภัย
const BOT_TOKEN = (process.env.BOT_TOKEN || '').trim();
const OWNER_ID = (process.env.OWNER_ID || '').trim();

if (!BOT_TOKEN) {
    console.error('❌ ไม่พบ BOT_TOKEN กรุณาตั้งค่า Environment Variable บน Cloud หรือสร้างไฟล์ .env ให้ถูกต้อง');
    process.exit(1);
}
...
// กำหนดไฟล์ JSON สำหรับบันทึกข้อมูล
...
// เรียกใช้งานเพื่อโหลดข้อมูลเดิมก่อนบอทเริ่มทำงาน
loadData();
...
// ======================================================
// GENERATE TOP PERFORMANCE IMAGE
// ======================================================
...
// ======================================================
// AUTO DETECT ALBIONBB LINK IN MESSAGES
// ======================================================
