...
// 🟢 ปรับเปลี่ยนการแสดงผล Top Performance Card ให้โชว์เฉพาะชื่อผู้เล่น (ตัด Guild ออก)
...
async function processBattleReport(input, targetContext, isMessage = false) {
    try {
        ...
        // 🟢 กำหนดขนาดคอลัมน์ใหม่ โดยตัด Guild ออก
        ...
        // 🟢 กรองแถวที่ไม่ใช่ผู้เล่นจริงออก (ป้องกันชื่อ Guild โผล่มาเป็นบรรทัดผู้เล่น)
        const rows = allSortedRows.filter(p => {
            ...
            // หากชื่อแถวตรงกับชื่อกิลด์พอดี ให้คัดออก (ยกเว้นเจาะจงติดตามชื่อนี้เป็นตัวละคร)
        ...
        // ส่วนหัวรายงาน (ไม่มีคอลัมน์ Guild)
        ...
        // 🟢 เพิ่มส่วนวิเคราะห์ MVP / Executioner / Feeder 
